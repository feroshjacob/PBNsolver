...
\bibitem{gpgpu}
J.~D. Owens, D.~Luebke, N.~Govindaraju, M.~Harris, J.~Krüger, A.~Lefohn, and
...
\bibitem{code2}
``Barnes tree code,'' \url{http://www.ifa.hawaii.edu/~barnes/treecode/},
  [Online; accessed 04-May-2012].

\bibitem{code3}
``Elucidation tree code,'' \url{http://www.prism.gatech.edu/~gth716h/BNtree/},
  [Online; accessed 04-May-2012].
...
\bibitem{bonzai}
J.~Bédorf, E.~Gaburov, and S.~P. Zwart, ``Bonsai: A {GPU} {T}ree-{C}ode,''
  2012.
...
D.~A. Pearlman, J.~W. Case, David A.~Caldwell, W.~S. Ross, T.~E. Cheatham,
  ...
  Communications}, vol.~91, no. 13, pp. 1 -- 41, Sep 1995.
